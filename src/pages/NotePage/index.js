        ...
        <div className="w-full">
            {note && (
                <div className="w-full p-4 shadow-lg rounded-lg">
                    <AlertSuccessDialog open={alert} message="Đã lưu ghi ch" />
                    ...
                    <div className="w-full py-4 flex flex-row items-center justify-between flex-wrap">
                        <NoteEditDialog
                            button={
                                <div className="group flex hover:underline select-none cursor-pointer flex-row items-center text-lg font-bold text-blue-500 w-full md:w-auto my-4 md:my-0">
                                    {note.name}
