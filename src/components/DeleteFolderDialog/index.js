...
function DeleteFolderDialog({ folderId, folderName, reload = () => {} }) {
    ...
    const submit = () => {
        noteFolderService.delete(folderId).then((data) => {
            reload();
            setAlert(true);
            setTimeout(() => {
                setAlert(false);
